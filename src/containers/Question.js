...
import { dataQuestion } from '../helpers/dataQuestion'
...
export default class Question extends Component {
    ...
    constructor() {
        super();
        // Estado donde recibe las preguntas
        this.state = {
            numberQuestion: 0,
            question: {
                question: "",
    ...
    // Funcion que trae las preguntas de la data
    componentDidMount() {
        axios.get(dataQuestion)
            .then(response => {
                // Trae la question según la posición del arreglo
    ...
    // Función que verifica si es correcta la respuesta y cambia de pregunta
    handleSubmit = (e) => {
        e.preventDefault();
        e.target.reset()
    ...
    render() {
        return (
            <StyledQuestion>
                ...
                <div >
                    <Answer>
                        <Image src="https://res.cloudinary.com/dvcxyjkko/image/upload/v1645053791/proyecto-sprint2/Property_1_3_awgirj.png" width="150" height="200" />

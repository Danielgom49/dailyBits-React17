...
import { dataQuestion3 } from '../helpers/dataQuestion3'
...
export default class Question3 extends Component {
    ...
    handleSubmit = (e) => {
        ...
        if (this.state.numberQuestion < 3) {
            ...
            window.localStorage.setItem("Score3", JSON.stringify(this.state.score))
            TimeFinally()
            console.log('Terminó');
    ...
    render() {
        return (
            <StyledQuestion>
                ...
                <div >
                    <Answer>
                        <Image src="https://res.cloudinary.com/dvcxyjkko/image/upload/v1645153313/proyecto-sprint2/Property_1_4_pprorl.png" width="150" height="200" />
